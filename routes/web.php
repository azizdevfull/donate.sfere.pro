...
Route::get('/oauth/proid/{isMobileOrWeb}/login', [OauthController::class, 'redirectToProId'])->name('proid.login');
Route::get('/oauth/proid/{isMobileOrWeb}/callback', [OauthController::class, 'handleProIdCallback']);
